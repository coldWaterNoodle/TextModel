...
const tables = [
    {
        name: 'Cafe Hospital Weekly Stats',
        description: '병원별 주간 카페 통계 (사전 집계)',
        fields: [
            { name: 'Stats Key', type: 'singleLineText', description: 'Hospital-WeekStart-Subject 조합 키' },
    ...
    {
        name: 'Cafe Hospital Monthly Stats',
        description: '병원별 월간 카페 통계 (사전 집계)',
        fields: [
            { name: 'Stats Key', type: 'singleLineText', description: 'Hospital-Month-Subject 조합 키' },
            { name: 'Hospital Name', type: 'singleLineText' },
...
async function main() {
    console.log('Starting Airtable table creation for Cafe Stats...');
